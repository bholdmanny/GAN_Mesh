...
} #0-263,268-473,484-500,221902-226986

src=Tools/CASIA-WebFace
#SelDir $src AI_CV_Train1 0 263
#SelDir $src AI_CV_Train2 268 473
#SelDir $src AI_CV_Test1 484 500
SelDir $src AI_CV_Test2 221902 226986
